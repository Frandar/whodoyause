...
7. **Category + query cannot be combined in the UI** although the API supports it — clicking a
   category chip while viewing search results *discards* the query (`browse/page.tsx:200-203`).
