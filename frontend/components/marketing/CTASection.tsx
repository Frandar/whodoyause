...
export function CTASection() {
  return (
    <section className="mx-auto w-full max-w-5xl px-4 py-12">
      <div className="flex flex-col items-center gap-4 rounded-3xl border border-border bg-secondary px-6 py-12 text-center shadow-soft">
        ...
        <Button asChild size="lg" className="mt-1 rounded-full">
